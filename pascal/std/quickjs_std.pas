...
// Worker hooks (no-op if worker support is not compiled in)
type
  TWorkerNewRuntimeFunc = function: PJSRuntime; cdecl;
  TWorkerNewContextFunc = function(rt: PJSRuntime): PJSContext; cdecl;
